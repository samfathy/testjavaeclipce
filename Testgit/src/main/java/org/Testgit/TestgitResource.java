...
public class TestgitResource {
	...
	static Logger logger = Logger.getLogger(TestgitResource.class.getName());
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/Testgit/resource/greet/{name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/Testgit/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/Testgit/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/Testgit/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/Testgit/resource/protected"
	 */
